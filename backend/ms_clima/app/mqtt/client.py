...
from backend.ms_clima.app.core.config import settings
from backend.ms_clima.app.database.session import SessionLocal
from backend.ms_clima.app.crud import crud_clima
from backend.ms_clima.app.schemas.clima import ClimaPayload
