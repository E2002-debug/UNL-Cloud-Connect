...
export default function Login() {
  ...
  return (
    <GoogleOAuthProvider clientId={GOOGLE_CLIENT_ID}>
      <div style={{ minHeight: '100vh', position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '20px', overflow: 'hidden' }}>
      ...
      `}</style>
        <div className="auth-container" style={{ position: 'relative', zIndex: 1, maxWidth: '960px', width: '100%', background: 'rgba(255, 255, 255, 0.95)', borderRadius: '16px', boxShadow: '0 20px 40px rgba(0, 0, 0, 0.3)', display: 'flex', overflow: 'hidden' }}>

          {/* Panel Izquierdo */}
          <div className="auth-left" style={{ flex: 1, background: `linear-gradient(to bottom, rgba(0,0,0,0.1) 0%, rgba(0,0,0,0.7) 100%), url(${fondoImg})`, backgroundSize: 'cover', backgroundPosition: 'center', color: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
