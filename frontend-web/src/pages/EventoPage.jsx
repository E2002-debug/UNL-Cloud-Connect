...
import { getEventoPorId, getImagenesEvento, uploadImage, obtenerNombresUsuarios, eliminarImagen } from "../components/dashboard/events/eventService";
...
export default function EventoPage() {
  ...
  const esAdministrador = () => {
    ...
    return String(idRol) === "1" || String(idRol) === "3";
  };
            ...
            {imagenes.map((img) => {
              ...
              return (
                <div key={img.id_imagen} style={{ background: "white", borderRadius: "8px", overflow: "hidden", boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
                  ...
                  {/* FOOTER: Reacciones + Eliminar (solo admin) */}
